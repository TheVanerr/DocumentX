...
| **ICC** | Kısa devre akımı — besleme hattı gereksinimi **10 kA** (**3.3.3**) |
...
| Terim | Açıklama |
|-------|----------|
| **Acil stop** | Fiziksel emniyet butonu; makinede **4 adet**; emniyet devresini açar (**2.5**, Error-229) |
| **Aktarma vanası** | Tanklar arası proses suyu aktarım pnömatik vanası (Error-304/305) |
...
| **Konveyör** | Servo tahrikli parça taşıma hattı; robot hattına entegre (**7.4**) |
| **Makine Stop** | HMI normal durdurma komutu (**7.3.1**) |
| **Makine Start** | HMI otomatik cycle başlatma komutu (**7.2.4**) |
| **Otomatik dolum vanası** | Tesis suyunu tanklara dolduran pnömatik vana (Error-300–303) |
| **Operatör tarafı** | HMI ve bakım erişimi — bu makinede **sağ** taraf (**3.5**) |
| **Ön filtre** | Yıkama tankı giriş filtresi; **günlük** temizlik (**10.1.3**) |
| **Pompa önü vana** | Pompa emiş hattı manuel vana; start öncesi **açık** olmalı (**7.2.5**) |
| **Proses fonksiyonu** | Yıkama, durulama, kurutma 1/2, egzoz — HMI'dan seçilir (**7.1.6**) |
...
| **7/24 çalışma** | Kesintisiz robot hattı operasyon modu (**7.5**, **8**) |
