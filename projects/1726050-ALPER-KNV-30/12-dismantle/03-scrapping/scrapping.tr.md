...
|-----------|------------|
| Hurda değerlendirme | Malzeme grubuna göre ayrıştırma yapılmalıdır |

### Hurda değerlendirme prosedürü

1. Demontaj parçalarını fiziksel olarak ayırın.
2. Aşağıdaki **12.3.2** tablosuna göre malzeme grubunu belirleyin.
3. Yerel bertaraf/geri dönüşüm lisanslı tesislerine sevk edin.
...
| Parametre | Gereksinim |
|-----------|------------|
| Parça geri dönüşüm malzemeleri | Kullanıldığı ülkenin mevcut geri dönüşüm mevzuatı |

| Malzeme grubu | Makinedeki örnek parçalar | Bertaraf / geri dönüşüm |
|---------------|---------------------------|-------------------------|
...
**Not:** Hurda değerlendirmede **Bölüm 13.3.1** parça listesi referans alınabilir; elektronik parçalarda seri numarası (**1726050**) bertaraf kaydında tutulmalıdır.
