...
Makine **7/24 robot** hattında kesintisiz çalışmaya uygundur. Nominal döngü süresi ve minimum kapasite referans değerleri **Bölüm 3.3.2**'de verilmiştir; bu bölümde tekrarlanmaz. Operasyon prosedürleri **Bölüm 7**'de; HMI parametre ayarları **Bölüm 6.3**'te anlatılmıştır.
...
| Nominal / maksimum kapasite | Kullanıcı firma belirler | — |
