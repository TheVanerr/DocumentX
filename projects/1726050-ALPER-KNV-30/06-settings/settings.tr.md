...
**Hedef kitle:** Hat sorumlusu (HMI set değerleri), bakım personeli (pnömatik regülatör, periyodik güvenlik testi), üretici servisi (PLC/encoder). PLC programı, encoder/feedback ve gömülü sürücü parametreleri yalnızca **üretici yetkili servisi** tarafından değiştirilmelidir.
